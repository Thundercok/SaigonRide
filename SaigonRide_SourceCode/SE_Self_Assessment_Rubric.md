...
| **(Tier 4 Only):** Source code/logs for Automation Tests, live external API, advanced Dashboard, and Live Cloud URL. | 10% | 10% | | Automation logs (41 Playwright tests passed), Stripe/SePay webhook APIs, Live URL on Railway, and real-time dashboard. |
